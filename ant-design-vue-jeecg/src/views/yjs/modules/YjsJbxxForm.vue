        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="性别代码" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="radio" v-decorator="['xbdm']" :trigger-change="true" dictCode="sex" placeholder="请选择性别代码"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/yjs/yjsJbxx/add",
          edit: "/yjs/yjsJbxx/edit",
          queryById: "/yjs/yjsJbxx/queryById"
        }
      }
    },
    computed: {
